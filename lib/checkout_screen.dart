            ...
            children: [
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    border: Border.all(
                      color: _tipoEntrega == 'recojo' ? Colors.pink : Colors.grey[300]!,
                      width: 2,
                    ),
                    borderRadius: BorderRadius.circular(12),
                    color: _tipoEntrega == 'recojo' ? Colors.pink.shade50 : Colors.white,
                  ),
                  child: Row(
                    children: [
                      Icon(
                        Icons.store,
                        size: 40,
                        color: _tipoEntrega == 'recojo' ? Colors.pink : Colors.grey,
                      ),
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                                color: _tipoEntrega == 'recojo' ? Colors.pink : Colors.black,
                              ),
                            ),
                            const SizedBox(height: 4),
                            const Text(
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    border: Border.all(
                      color: _tipoEntrega == 'delivery' ? Colors.pink : Colors.grey[300]!,
                      width: 2,
                    ),
                    borderRadius: BorderRadius.circular(12),
                    color: _tipoEntrega == 'delivery' ? Colors.pink.shade50 : Colors.white,
                  ),
                  child: Row(
                    children: [
                      Icon(
                        ...
                        size: 40,
                        color: _tipoEntrega == 'delivery' ? Colors.pink : Colors.grey,
                      ),
                      const SizedBox(width: 16),
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                                color: _tipoEntrega == 'delivery' ? Colors.pink : Colors.black,
                              ),
                            ),
                            const SizedBox(height: 4),
                            const Text(
              ...
              TextFormField(
                ...
                maxLines: 3,
                decoration: InputDecoration(
                  hintText: 'Ej: Te amo con todo mi corazón...',
                  border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(12),
                  ),
                  focusedBorder: OutlineInputBorder(
