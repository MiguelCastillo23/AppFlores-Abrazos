...
class _ProductosScreenState extends State<ProductosScreen> {
  ...
  final List<Map<String, dynamic>> _categorias = [
    ...
    {'nombre': 'Rosas', 'icono': FontAwesomeIcons.solidHeart}, 
    {'nombre': 'Tulipanes', 'icono': FontAwesomeIcons.gripfire}, 
    {'nombre': 'Margaritas', 'icono': FontAwesomeIcons.sun},
    {'nombre': 'Arreglos', 'icono': FontAwesomeIcons.gift},
    {'nombre': 'Peluches', 'icono': FontAwesomeIcons.duolingo}, 
  ];
